                    ...
                    <div className="pl-5 pr-0 border-r-2 border-[#F4F4F5]">
                        <div className="w-[300px]" >
                            ...
                            <div className="text-center">
                                ...
                                <h1 className="font-semibold text-xl">{user.user_metadata.full_name}</h1>
                        ...
                        <div>
                            <form action="">
                                ...
                                <div className="mt-3">
                                    ...
                                    <input type="text" name="name" id="name" placeholder={user.user_metadata.full_name} className="w-full bg-[#F4F4F5] placeholder-[#495560] text-sm px-4 py-3 mt-1" />
                                </div>
                                ...
                                <div className="mt-3">
                                    ...
                                    <input type="tel" name="phone" id="phone" placeholder={user.user_metadata.phone} className="w-full bg-[#F4F4F5] placeholder-[#495560] text-sm px-4 py-3 mt-1" />
                                </div>

                                <div className="mt-3">
                                    <label className="font-semibold text-sm" htmlFor="name">Email Address</label>
                                    <input type="email" name="email" id="email" placeholder={user.user_metadata.email} className="w-full bg-[#F4F4F5] placeholder-[#495560] text-sm px-4 py-3 mt-1" />
                                </div>
