        ...
        <div className='grid grid-cols-3 gap-10'>
          <div className='text-justify'>
            ...
            <p className='text-xs pt-5'>
              Explore the world with our exclusive travel packages designed to create unforgettable 
              memories. Whether you're dreaming of a tropical beach getaway, a thrilling adventure in the mountains, 
              or a cultural journey through historic cities, we have the perfect itinerary for you. 
            </p>
          </div>
